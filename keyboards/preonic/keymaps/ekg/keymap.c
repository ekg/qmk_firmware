...
[_LOWER] = LAYOUT_preonic_grid(
  ...
  BACKLIT, KC_ESC,  KC_LGUI, KC_LALT, _______, KC_SPC,  KC_SPC,  MO(3),   KC_BSPC, KC_UP,   KC_DOWN, KC_LEFT
),
...
[_RAISE] = LAYOUT_preonic_grid(
  ...
  BACKLIT, KC_ESC,  KC_LGUI, KC_LALT, MO(3),   KC_SPC,  KC_SPC,  _______, KC_BSPC, KC_UP,   KC_DOWN, KC_LEFT
),
